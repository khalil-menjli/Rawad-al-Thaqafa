...
router.get  ('/:id',        tasksCtrl.getTaskById);
...
// Task progress & claim
router.get  ('/:taskId/status', verifyToken, tasksCtrl.checkTaskStatus);
router.post ('/:taskId/claim',  verifyToken, tasksCtrl.claimTask);
router.get  ('/claimed',        verifyToken, tasksCtrl.getClaimedTasks);
